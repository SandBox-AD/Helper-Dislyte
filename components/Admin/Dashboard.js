                    ...
                    <Card variant="bg-thistle">
                        ...
                        <CardContent>
                            ...
                            >
                                ...
                                >
                                    <Avatar
                                        alt={indexRelique4.name}
                                        src={indexRelique4.image}
                                    />
                                ...
                                >
                                    <Avatar
                                        alt={indexRelique2.name}
                                        src={indexRelique2.image}
                                    />
                                    <Typography variant="body1">
                                        {indexRelique2.name}
                                    </Typography>
